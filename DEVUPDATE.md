# DEVUPDATE.md - v3.1.2 Release and Publish Runbook

## Purpose

Use this checklist to ship the i18ntk v3.1.2 release to npm and keep docs/readme in sync.
...
- `README.md`
- `docs/README.md`
- `docs/migration-guide-v3.1.2.md` (or new migration file for the target release)
