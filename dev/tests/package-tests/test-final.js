...
const TEST_DIR = `test-final-${timestamp}`;
...
try {
  ...
  execSync('node -e "console.log(fs.readdirSync(path.join(require.resolve(\'i18ntk/ui-locales/en.json\'), \'..\')))"', { stdio: 'inherit' });
...
console.log('\n✨ Final test completed - no version conflicts!');