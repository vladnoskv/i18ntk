# i18ntk Configuration Guide (v4.3.0)
...
- `defaultLanguages`: target languages used by init, completion, and manager Auto Translate. In `4.3.0`, the default set includes `en`, `de`, `es`, `fr`, and `ru`.
...
- `markdown`: readable `.md` reports, default in `4.3.0`
